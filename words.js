export const WORDS = [
  "ABIDE", "ABORT", "ABOUT", "ABOVE", "ABUSE", "ACORN", "ACRID", "ACTOR", "ACUTE", "ADEPT",
  "ADMIT", "ADOBE", "ADOPT", "ADORE", "ADULT", "AEGIS", "AFIRE", "AFORE", "AFTER", "AGENT",
  "AGILE", "AGING", "AGLOW", "AGONY", "AHEAD", "AIDED", "AIDES", "AILED", "AIMED", "AIRED",
  "AISLE", "ALARM", "ALBUM", "ALERT", "ALIEN", "ALIGN", "ALIKE", "ALIVE", "ALOFT", "ALONE",
  "ALOUD", "ALTER", "AMBER", "AMBLE", "AMEND", "AMPLE", "AMPLY", "AMUSE", "ANGEL", "ANGER",
  "ANGLE", "ANGRY", "ANGST", "ANKLE", "ANTIC", "ANVIL", "APPLY", "APRON", "APTLY", "ARDOR",
  "ARGUE", "ARISE", "ARMED", "AROSE", "ARSON", "ARTSY", "ASCOT", "ASHEN", "ASIDE", "ASKED",
  "ASKEW", "ASPEN", "ATONE", "ATTIC", "AUDIO", "AUDIT", "AUNTY", "AVAIL", "AVERT", "AVOID",
  "AWFUL", "AWOKE", "AXIOM", "AXLES", "AZURE", "BACON", "BADGE", "BADLY", "BAGEL", "BAKER",
  "BALER", "BALMY", "BANJO", "BARGE", "BARON", "BASIL", "BASIN", "BATCH", "BATHE", "BATON",
  "BAYOU", "BEACH", "BEADS", "BEADY", "BEAMY", "BEARD", "BEAST", "BEAUT", "BEGAN", "BEGET",
  "BEGIN", "BEING", "BELAY", "BELCH", "BELOW", "BENCH", "BERET", "BERTH", "BESET", "BETEL",
  "BEVEL", "BIBLE", "BICEP", "BIDDY", "BIGOT", "BILGE", "BILLY", "BINGE", "BINGO", "BIOME",
  "BIRCH", "BIRTH", "BISON", "BITCH", "BITE", "BLACK", "BLADE", "BLAME", "BLAND", "BLANK",
  "BLARE", "BLAST", "BLAZE", "BLEAK", "BLEAT", "BLEND", "BLIMP", "BLIND", "BLINK", "BLITZ",
  "BLOAT", "BLOCK", "BLOKE", "BLOND", "BLOOD", "BLOOM", "BLOWN", "BLUER", "BLUFF", "BLUNT",
  "BLURB", "BLURT", "BLUSH", "BOARD", "BOAST", "BOBBY", "BONEY", "BONGO", "BONUS", "BOOBY",
  "BOOST", "BOOTH", "BOOTY", "BOOZE", "BOOZY", "BORAX", "BORED", "BOTCH", "BOUGH", "BOULE",
  ...
  "CANAL", "CANDY", "CANOE", "CANON", "CAPER", "CAPUT", "CARAT", "CARGO", "CAROL", "CARRY",
  "CARVE", "CASTE", "CATCH", "CATER", "CATTY", "CAULK", "CAUSE", "CAVIL", "CEASE", "CEDAR",
  "CELLO", "CHAFE", "CHAFF", "CHAIN", "CHAIR", "CHALK", "CHAMP", "CHANT", "CHAOS", "CHARD",
  "CHARM", "CHART", "CHASM", "CHEAT", "CHECK", "CHEEK", "CHEER", "CHESS", "CHEST", "CHICK",
  ...
  "CLOVE", "CLOWN", "CLUB", "CLUCK", "CLUED", "CLUMP", "CLUNG", "COACH", "COAST", "COBRA",
  "COCOA", "COLEL", "COLOR", "COMBO", "COMET", "COMFY", "COMIC", "COMMA", "CONCH", "CONDO",
  ...
  "DICEY", "DIESEL", "DIET", "DIGIT", "DILATE", "DIMLY", "DINER", "DINGO", "DINGY", "DIODE",
  "DIRGE", "DIRTY", "DISCO", "DITCH", "DITTO", "DITTY", "DIVER", "DIZZY", "DODGE", "DODGY",
  "DOGMA", "DOILY", "DOING", "DOLE", "DOLLY", "DONOR", "DONUT", "DOPEY", "DOUBT", "DOUGH",
  "DOWDY", "DOWEL", "DOWNY", "DOWRY", "DOZEN", "DRAFT", "DRAIN", "DRAKE", "DRAMA", "DRANK",
  "DRAPE", "DRAWL", "DRAWN", "DREAM", "DRESS", "DRIED", "DRIER", "DRIFT", "DRILL", "DRINK",
  ...
  "FIFTY", "FIGHT", "FILER", "FILET", "FILMY", "FILTH", "FINAL", "FINCH", "FINE", "FINER",
  ...
  "HUMUS", "HUNCH", "HUNKY", "HUNT", "HURL", "HURRY", "HURT", "HUSK", "HUSKY", "HUTCH",
  "HYDRO", "HYENA", "HYMEN", "HYPER", "ICILY", "ICING", "IDEAL", "IDIOM", "IDIOT", "IDLE",
  "IDLER", "IDOL", "IGLOO", "IMAGE", "IMBUE", "IMPEL", "IMPLY", "INANE", "INBOX", "INCUR",
  "INDEX", "INEPT", "INERT", "INFER", "INGOT", "INJECT", "INKY", "INLAY", "INLET", "INNER",
  "INPUT", "INTER", "INTRO", "IONIC", "IRATE", "IRON", "IRONY", "ISLET", "ISSUE", "ITCHY",
  "IVORY", "JAUNT", "JAZZY", "JELLY", "JERKY", "JETTY", "JEWEL", "JIFFY", "JOINT", "JOIST",
  "JOKER", "JOLLY", "JOUST", "JUDGE", "JUICE", "JUICY", "JUMBO", "JUMP", "JUMPY", "JUNTA",
  "JUTE", "KAPUT", "KARMA", "KAYAK", "KEBAB", "KHAKI", "KIOSK", "KNAVE", "KNEAD", "KNEE",
  "KNEEL", "KNELT", "KNIFE", "KNIT", "KNOB", "KNOCK", "KNOLL", "KNOT", "KNOWN", "KOALA",
  "KRILL", "LABEL", "LABOR", "LACED", "LACK", "LADEN", "LADLE", "LAGER", "LANCE", "LAND",
  "LANKY", "LAPEL", "LAPSE", "LARGE", "LARVA", "LASSO", "LATCH", "LATER", "LATHE", "LATTE",
  "LAUGH", "LAYER", "LEACH", "LEAFY", "LEAKY", "LEANT", "LEAP", "LEARN", "LEASE", "LEASH",
  ...
  "LOBBY", "LOCAL", "LOCUS", "LODGE", "LOFTY", "LOGIC", "LOGIN", "LONER", "LONG", "LOOPY",
  "LOOSE", "LORRY", "LOSER", "LOUSE", "LOUSY", "LOVER", "LOWER", "LOWLY", "LOYAL", "LUCID",
  "LUCKY", "LUMEN", "LUMPY", "LUNAR", "LUNCH", "LUNGE", "LUPUS", "LURCH", "LURE", "LURID",
  ...
  "MARSH", "MASON", "MASQUE", "MASS", "MATCH", "MATE", "MATTE", "MAUVE", "MAXIM", "MAYBE",
  "MAYOR", "MEALY", "MEANT", "MEATY", "MECCA", "MEDAL", "MEDIA", "MEDIC", "MELEE", "MELON",
  "MELT", "MEMO", "MERCY", "MERGE", "MERIT", "MERRY", "METAL", "METER", "METRO", "MICRO",
  "MIDST", "MIGHT", "MILKY", "MIMIC", "MINCE", "MINER", "MINI", "MINOR", "MINTY", "MINUS",
  "MIRTH", "MISER", "MISSY", "MOCHA", "MODAL", "MODEL", "MODEM", "MOIST", "MOLAR", "MOLDY",
  "MONEY", "MONTH", "MOODY", "MOOSE", "MORAL", "MORON", "MORPH", "MOSSY", "MOTEL", "MOTIF",
  "MOTOR", "MOTTO", "MOULT", "MOUND", "MOUNT", "MOURN", "MOUSE", "MOUTH", "MOVE", "MOVIE",
  ...
  "NICHE", "NIECE", "NIGHT", "NINJA", "NINNY", "NINTH", "NOBLE", "NP", "NOISE", "NOISY",
  "NOMAD", "NOOSE", "NORTH", "NOSE", "NOTCH", "NOTE", "NOVEL", "NURSE", "NUTTY", "NYLON",
  ...
  "PESTO", "PETAL", "PETTY", "PHASE", "PHONE", "PHONY", "PHOTO", "PIANO", "PICK", "PIECE",
  ...
  "PLUME", "PLUMP", "PLUNK", "PLUSH", "POINT", "POISE", "POKER", "POLAR", "POLKA", "POLL",
  "POPPY", "PORCH", "PORED", "POSER", "POSEUR", "POSSE", "POUCH", "POUND", "POUTY", "POWER",
  ...
  "RANGE", "RAPID", "RARE", "RASPY", "RATIO", "RATION", "RAVEN", "RAYON", "RAZOR", "REACH",
  "REACT", "READ", "READY", "REALM", "REARM", "REBAR", "REBEL", "REBUS", "REBUT", "RECAP",
  "RECOIL", "RECON", "RECUR", "REDDER", "REDUX", "REED", "REEF", "REEK", "REEL", "REFER",
  ...
  "RINK", "RINSE", "RIPEN", "RIPER", "RISEN", "RISER", "RISKY", "RIVAL", "RIVER", "RIVET",
  "ROACH", "ROAST", "ROBIN", "ROBOT", "ROCKY", "RODEO", "ROGUE", "ROOM", "ROOMY", "ROOST",
  "ROOT", "ROPE", "ROSE", "ROTOR", "ROUGE", "ROUGH", "ROUND", "ROUSE", "ROUTE", "ROVER",
  "ROWDY", "ROWER", "ROYAL", "RUDDY", "RUDER", "RUGBY", "RULER", "RUMBA", "RUMOR", "RUPEE",
  "RUST", "RUSTY", "SACK", "SADLY", "SAFER", "SAINT", "SALAD", "SALLY", "SALON", "SALSA",
  "SALTY", "SALVE", "SALVO", "SANDY", "SANER", "SAPPY", "SASSY", "SATIN", "SATIRE", "SAUCE",
  "SAUCY", "SAUNA", "SAUTE", "SAVER", "SAVOR", "SAVOY", "SAVVY", "SCALD", "SCALE", "SCALP",
  "SCALY", "SCAMP", "SCAN", "SCARE", "SCARF", "SCARY", "SCENE", "SCENT", "SCION", "SCOFF",
  ...
  "SHIP", "SHIRE", "SHIRK", "SHIRT", "SHOAL", "SHOCK", "SHONE", "SHOOK", "SHOOT", "SHOP",
  "SHORE", "SHORN", "SHORT", "SHOUT", "SHOVE", "SHOW", "SHOWN", "SHOWY", "SHREW", "SHRUB",
  "SHRUG", "SHUCK", "SHUN", "SHUNT", "SHUSH", "SHYLY", "SIEGE", "SIEVE", "SIGHT", "SIGMA",
  "SILKY", "SILLY", "SINCE", "SINEW", "SINGE", "SIREN", "SISSY", "SIXTH", "SIXTY", "SKATE",
  "SKIER", "SKIFF", "SKILL", "SKIMP", "SKIN", "SKIRT", "SKULK", "SKULL", "SKUNK", "SLACK",
  "SLAIN", "SLANG", "SLANT", "SLASH", "SLATE", "SLEEK", "SLEEP", "SLEET", "SLEPT", "SLICE",
  "SLICK", "SLIDE", "SLIME", "SLIMY", "SLING", "SLINK", "SLIP", "SLIT", "SLOPE", "SLOSH",
  "SLOTH", "SLUMP", "SLUNG", "SLUR", "SLURP", "SLUSH", "SLYLY", "SMACK", "SMALL", "SMART",
  "SMASH", "SMEAR", "SMELL", "SMELT", "SMILE", "SMIRK", "SMITE", "SMITH", "SMOCK", "SMOKE",
  "SMOKY", "SMOTE", "SNACK", "SNAIL", "SNAKE", "SNAKY", "SNAP", "SNARE", "SNARL", "SNEAK",
  "SNEER", "SNIFF", "SNIPE", "SNOOP", "SNORE", "SNORT", "SNOUT", "SNOWY", "SNUCK", "SNUFF",
  "SOAP", "SOAPY", "SOBER", "SOCCER", "SODA", "SOGGY", "SOLAR", "SOLID", "SOLVE", "SONAR",
  ...
  "SPOOK", "SPOOL", "SPOON", "SPORE", "SPORT", "SPOT", "SPOUT", "SPRAY", "SPREE", "SPRIG",
  ...
  "TITAN", "TITHE", "TITLE", "TOAST", "TODAY", "TODDY", "TOKEN", "TONAL", "TONGS", "TONIC",
  ...
  "UNION", "UNITE", "UNITY", "UNLIT", "UNMET", "UNTIE", "UNTIL", "UNWED", "UNZIP", "UPPER",
...
].filter(word => (new Set(word)).size === 5);
